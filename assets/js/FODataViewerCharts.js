        ...
        },
        {
            ...
            "sourceCategoryList": [
                ...
                },
                {
                    ...
                    "title_fi": "BASGRA_N takautuva mallinnus",
                    "title_sv": "BASGRA_N återanalys",
                    "description": "TEST! Hindcast (past) and forecast (future) are predicted values by the BASGRA_N process-based grassland model ([Höglind et al., 2020, *Ecol. Modelling*](https://doi.org/10.1016/j.ecolmodel.2019.108925 'Höglind, Mats, et al. \"BASGRA_N: A model for grassland productivity, quality and greenhouse gas balance.\" Ecological Modelling 417 (2020): 108925.')). The 90&nbsp;% confidence intervals for hindcast and forecast are generated by 250 ensemble members, with different combinations of model parameters, initial conditions and meteorological drivers. The forecasts update daily around 16 UTC.",
                    "description_fi": "Takautuva mallinnus ja ennuste on tehty nurmimaille kehitetyllä prosessipohjaisella BASGRA_N -mallilla ([Höglind et al., 2020, *Ecol. Modelling*](https://doi.org/10.1016/j.ecolmodel.2019.108925 'Höglind, Mats, et al. \"BASGRA_N: A model for grassland productivity, quality and greenhouse gas balance.\" Ecological Modelling 417 (2020): 108925.')). 90&nbsp;% luottamusvälit on laskettu tekemällä 250 erillistä mallinnusta erilaisilla malliparametrien, mallinnuksen alkutilojen ja meteorologisten muuttujien yhdistelmillä. Ennuste päivittyy joka päivä n. klo 16:00 (UTC).",
                    "description_sv": "Retroaktiv modellering samt prognosen görs med den processbaserade BASGRA_N modellen utvecklad för gräsmarker ([Höglind et al., 2020, *Ecol. Modelling*](https://doi.org/10.1016/j.ecolmodel.2019.108925 'Höglind, Mats, et al. \"BASGRA_N: A model for grassland productivity, quality and greenhouse gas balance.\" Ecological Modelling 417 (2020): 108925.')). 90&nbsp;% konfidensintervaller har beräknats genom att göra 250 separata modelleringar med olika kombinationer av modellparametrar, modellering av initialtillstånd och meteorologiska variabler. Prognosen uppdateras varje dag ca kl. 16:00 (UTC)."
                },
                {
                    "id": "basgra_n_forecast",
                    "title": "BASGRA_N forecast",
                ...
                },
                {
                    ...
                    "title_fi": "BASGRA-BGC takautuva mallinnus",
                    "title_sv": "BASGRA-BGC återanalys",
                    "description": "Hindcast (past) shows predicted values by the BASGRA-BGC process-based grassland model ([Huang et al., 2021, *Sci. Total Environ.*](https://doi.org/10.1016/j.scitotenv.2020.144385 'Huang, Xiao, et al. \"Modelling CO2 and CH4 emissions from drained peatlands with grass cultivation by the BASGRA-BGC model.\" Science of the Total Environment 765 (2021): 144385.')). The 90&nbsp;% confidence intervals for hindcast and forecast are generated by 100 ensemble members, with different combinations of model parameters and initial conditions.",
                    "description_fi": "Takautuva mallinnus on tehty nurmimaille kehitetyllä prosessipohjaisella BASGRA-BGC -mallilla ([Huang et al., 2021, *Sci. Total Environ.*](https://doi.org/10.1016/j.scitotenv.2020.144385 'Huang, Xiao, et al. \"Modelling CO2 and CH4 emissions from drained peatlands with grass cultivation by the BASGRA-BGC model.\" Science of the Total Environment 765 (2021): 144385.')). 90&nbsp;% luottamusvälit on laskettu tekemällä 100 erillistä mallinnusta erilaisilla malliparametrien ja mallinnuksen alkutilojen yhdistelmillä.",
                    "description_sv": "Retroaktiv modellering görs med den processbaserade BASGRA-BGC -modellen utvecklad för gräsmarker ([Huang et al., 2021, *Sci. Total Environ.*](https://doi.org/10.1016/j.scitotenv.2020.144385 'Huang, Xiao, et al. \"Modelling CO2 and CH4 emissions from drained peatlands with grass cultivation by the BASGRA-BGC model.\" Science of the Total Environment 765 (2021): 144385.')). 90&nbsp;% konfidensintervaller har beräknats genom att göra 100 separata modelleringar med olika kombinationer av modellparametrar och modellering av initialtillstånd."
                },
                {
                    "id": "basgra_bgc_forecast",
                    "title": "BASGRA-BGC forecast",
                ...
                },
                {
                    ...
                    "title_fi": "STICS takautuva mallinnus",
                    "title_sv": "STICS återanalys",
                    "description": "Hindcast (past) shows predicted values by the STICS process-based crop model (Brisson et al., [1998](https://doi.org/10.1051/agro:19980501 'Brisson, Nadine, et al. \"STICS: a generic model for the simulation of crops and their water and nitrogen balances. I. Theory and parameterization applied to wheat and corn.\" Agronomie 18.5-6 (1998): 311-346.'), [2002](https://doi.org/10.1051/agro:2001005 'Brisson, Nadine, et al. \"STICS: a generic model for simulating crops and their water and nitrogen balances. II. Model validation for wheat and maize.\" Agronomie 22.1 (2002): 69-92.'), *Agronomie*). The 90&nbsp;% confidence intervals for hindcast and forecast are generated by 250 ensemble members, with different combinations of model parameters and initial conditions.",
                    "description_fi": "Takautuva mallinnus on tehty prosessipohjaisella STICS -mallilla  (Brisson et al., [1998](https://doi.org/10.1051/agro:19980501 'Brisson, Nadine, et al. \"STICS: a generic model for the simulation of crops and their water and nitrogen balances. I. Theory and parameterization applied to wheat and corn.\" Agronomie 18.5-6 (1998): 311-346.'), [2002](https://doi.org/10.1051/agro:2001005 'Brisson, Nadine, et al. \"STICS: a generic model for simulating crops and their water and nitrogen balances. II. Model validation for wheat and maize.\" Agronomie 22.1 (2002): 69-92.'), *Agronomie*). 90&nbsp;% luottamusvälit on laskettu tekemällä 250 erillistä mallinnusta erilaisilla malliparametrien ja mallinnuksen alkutilojen yhdistelmillä.",
                    "description_sv": "Retroaktiv modellering görs med den processbaserade STICS -modellen (Brisson et al., [1998](https://doi.org/10.1051/agro:19980501 'Brisson, Nadine, et al. \"STICS: a generic model for the simulation of crops and their water and nitrogen balances. I. Theory and parameterization applied to wheat and corn.\" Agronomie 18.5-6 (1998): 311-346.'), [2002](https://doi.org/10.1051/agro:2001005 'Brisson, Nadine, et al. \"STICS: a generic model for simulating crops and their water and nitrogen balances. II. Model validation for wheat and maize.\" Agronomie 22.1 (2002): 69-92.'), *Agronomie*). 90&nbsp;% konfidensintervaller har beräknats genom att göra 250 separata modelleringar med olika kombinationer av modellparametrar och modellering av initialtillstånd."
                },
                {
                    "id": "stics_forecast",
                    "title": "STICS forecast",
